...
/*   Updated: 2024/06/07 20:17:01 by davgalle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../incl/minishell.h"

static void	ft_doubles(char c, int *doubles, int *single, int *post_exp)
{
	(void)post_exp;
	if (c == '"')
	{
...
static void	ft_singles(char c, int *doubles, int *single, int *post_exp)
{
	(void)post_exp;
	if (c == '\'')
	{
